...
*/
public class ActivitySenseDao extends AbstractDao<ActivitySense, Long> {
    ...
    */
    ...
    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, ActivitySense entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public ActivitySense readEntity(Cursor cursor, int offset) {
        ActivitySense entity = new ActivitySense( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, ActivitySense entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(ActivitySense entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(ActivitySense entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
