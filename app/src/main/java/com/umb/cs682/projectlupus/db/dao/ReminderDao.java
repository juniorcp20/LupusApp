...
public class ReminderDao extends AbstractDao<Reminder, Long> {
    ...
    */
    ...
    private Query<Reminder> medicine_MedRemindersQuery;
    ...
    public List<Reminder> _queryMedicine_MedReminders(long medId) {
        synchronized (this) {
        ...
        Query<Reminder> query = medicine_MedRemindersQuery.forCurrentThread();
